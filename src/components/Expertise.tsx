...
const Expertise = () => {
  ...
  return (
    <section id="expertise" className="py-20 md:py-32 bg-gradient-to-b from-beige/90 to-white relative overflow-hidden">
      {/* Background pattern */}
      <div className="pattern-overlay bg-dots-pattern"></div>
      
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-24 h-24 bg-orange/20 rounded-full blur-2xl"></div>
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-orange/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-charcoal">My Expertise</h2>
          <Separator className="w-16 h-1 bg-gradient-to-r from-orange to-orange-light mx-auto mb-8" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className={`absolute inset-x-0 h-1 top-0 bg-gradient-to-r from-orange to-orange-light transition-opacity duration-300 ${hoveredCard === 0 ? 'opacity-100' : 'opacity-0'}`}></div>
            <CardHeader className="pb-2">
              <div className="w-12 h-12 bg-gradient-to-r from-orange to-orange-light rounded-xl flex items-center justify-center mb-4 shadow-lg transform transition-transform duration-300 group-hover:scale-110">
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-orange mr-2 flex-shrink-0 mt-0.5" />
          ...
          <Card 
            ...
            onMouseLeave={() => setHoveredCard(null)}
          >
            <div className={`absolute inset-x-0 h-1 top-0 bg-gradient-to-r from-orange to-orange-light transition-opacity duration-300 ${hoveredCard === 1 ? 'opacity-100' : 'opacity-0'}`}></div>
            <CardHeader className="pb-2">
              <div className="w-12 h-12 bg-gradient-to-r from-orange to-orange-light rounded-xl flex items-center justify-center mb-4 shadow-lg">
          ...
          <Card 
            ...
            onMouseLeave={() => setHoveredCard(null)}
          >
            <div className={`absolute inset-x-0 h-1 top-0 bg-gradient-to-r from-orange to-orange-light transition-opacity duration-300 ${hoveredCard === 2 ? 'opacity-100' : 'opacity-0'}`}></div>
            <CardHeader className="pb-2">
              <div className="w-12 h-12 bg-gradient-to-r from-orange to-orange-light rounded-xl flex items-center justify-center mb-4 shadow-lg">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-6 md:gap-10">
            <div className="tech-icon flex flex-col items-center animate-fade-in" style={{animationDelay: "0.1s"}}>
              <div className="w-14 h-14 bg-white rounded-full shadow-md flex items-center justify-center mb-2">
                <svg viewBox="0 0 24 24" className="w-8 h-8 text-orange" fill="currentColor">
              ...
              <p className="text-sm font-medium text-graphite">React</p>
            </div>
            ...
            <div className="tech-icon flex flex-col items-center animate-fade-in" style={{animationDelay: "0.2s"}}>
              ...
              <p className="text-sm font-medium text-graphite">PHP</p>
            </div>
            ...
            <div className="tech-icon flex flex-col items-center animate-fade-in" style={{animationDelay: "0.3s"}}>
              ...
              <p className="text-sm font-medium text-graphite">Java</p>
            </div>
            ...
            <div className="tech-icon flex flex-col items-center animate-fade-in" style={{animationDelay: "0.4s"}}>
              ...
              <p className="text-sm font-medium text-graphite">.NET</p>
            </div>
            ...
            <div className="tech-icon flex flex-col items-center animate-fade-in" style={{animationDelay: "0.5s"}}>
              ...
              <p className="text-sm font-medium text-graphite">Vue.js</p>
            </div>
            ...
            <div className="tech-icon flex flex-col items-center animate-fade-in" style={{animationDelay: "0.6s"}}>
              ...
              <p className="text-sm font-medium text-graphite">Laravel</p>
            </div>
          </div>
        </div>
      </div>
