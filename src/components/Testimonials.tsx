          ...
          <Card className="bg-white/10 border-0 h-full flex flex-col">
            <CardContent className="pt-6 flex-grow">
              <div className="mb-4 flex items-start">
                <svg className="w-8 h-8 text-white/50 mr-2" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Card className="bg-white/10 border-0 h-full flex flex-col">
            <CardContent className="pt-6 flex-grow">
              <div className="mb-4 flex items-start">
                ...
                <div className="w-8 h-8 rounded-full bg-white/10 overflow-hidden flex-shrink-0">
                  <div className="w-full h-full bg-gradient-to-br from-green-400 to-blue-600"></div>
                </div>
              </div>
              <p className="text-lg mb-4">
